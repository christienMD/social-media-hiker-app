...
function App() {
  return (
    <div className="min-h-screen text-white">
      <div className="grid grid-cols-1 lg:grid-cols-[300px,1fr,1fr,1fr,300px] grid-rows-[auto,1fr] min-h-screen">
        ...
        <AsideRight className="hidden lg:block lg:sticky max-h-[calc(100vh-4rem)] -top-56" />
      </div>
      <Footer />
    </div>
  );
